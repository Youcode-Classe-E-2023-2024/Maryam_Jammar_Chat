...
<div class="font-sans antialiased h-screen flex ">
    ...
    <div class="bg-gray-800 text-purple-lighter flex-none w-64 pb-6 hidden md:block">
        ...
        <div class="mb-8">
            <div class="px-4 mb-2 text-white flex justify-between items-center">
                <div class="opacity-75 cursor-pointer">Room members</div>
                <div>
                    <svg class="fill-current h-5 w-5 opacity-50 cursor-pointer"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
            ...
            <div
                ...
                <?php
                foreach ($members as $room_member){
    ...
    <div class="flex-1 flex flex-col bg-gray-700 overflow-hidden">
        ...
        <!-- Chat messages -->
        <div id="messageSection" class="px-6 py-4 flex-1 overflow-y-scroll">

        </div>
        <div class="pb-6 px-4 flex-none">
            <form>
                <div class="flex rounded-lg overflow-hidden">
                    <input id="room-id" type="hidden" value="<?php echo $_SESSION['current-room'] ?>">

                    </input>
                    <input id="message-input" type="text" name="message" class="w-full px-2 bg-gray-600 h-15" placeholder="Message" />
                    <span>
                        <button id="message-btn" name="submitMsg" type="submit" class="text-xl text-grey px-4  border-gray-600 bg-gray-400 p-2">
                            Send
